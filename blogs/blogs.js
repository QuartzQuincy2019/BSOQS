...
var blogs = [
    ...
    */
    {
        type: "blog",
        id: "23879q38nnzxvgyi42942viowusi",
        date: "2026-04-15",
        edited: "2026-04-16",
        authors: [
        ...
        contents: ["h1[零、前言]h1",
            "[干支法是一套个人搜索、归纳并总结的有关干支计算的规则集合。新干支法是干支法的改良，加入了部分干支历信息的求算规则。]",
            "h1[一、干支]h1",
            "[十个天干与十二个地支相配，奇天干与奇地支配，偶天干与偶地支相配，共有60个干支。取第一个天干“甲”，第一个地支“子”，合称曰“六十甲子”。][在新干支法中，有时为了简化表述，用c[H]c代称“天干”，用c[E]c代称“地支”。]",
            "h2[1.1 周期性]h2",
            "[从第1个干支“甲子”到第60个干支“癸亥”，干支顺次更迭，以六十为周期，六十次更迭后周而复始。][第1个干支是“甲子”，由第1个天干“甲”和第1个地支“子”组成。下一个干支，是天干和地支的序列同时增加1，即“乙丑”。再下一个，“丙寅”，再下一个，“丁卯”。H或E的序列用完了，则它从头开始。如第10个“癸酉”，则第11个为“甲戌”，天干从头开始。第12个“乙亥”，则第13个为“丙子”，地支从头开始。]",
            "h2[1.2 干支的存在性]h2",
            "t[ƈ{InlineBlock}^^|奇天干|偶天干||甲|乙||丙|丁||戊|己||庚|辛||壬|癸|$]t",
            "t[ƈ{InlineBlock}^^|奇地支|偶地支||子|丑||寅|卯||辰|巳||午|未||申|酉||戌|亥|$]t",
            "[不存在奇H与偶E、偶H与奇E配合的干支。比如，不存在“甲丑”“乙寅”“丙卯”“丁辰”的干支。]",
            "h1[二、干支法]h1",
            "[归纳于2024年5月。干支法主要用于干支的次序计算。]",
            "h2[2.1 干支次序推算]h2",
            "[从1（甲子）至60（癸亥），顺次一一对应。它的核心口诀：]",
            "bq[ƈ{cross}[天干顺跳加十二，地支逆跳加十年。]]bq",
            "[其中“跳”的概念是，从当前的H/E跳跃到下一个相同奇偶性的H/E。比如从“乙”(2)到“丁”(4)、从“庚”(7)到“壬”(9)是“天干顺跳1次”；从“寅”(3)到“子”(1)、从“未”(8)到“巳”(6)是“地支逆跳1次”。][这句口诀是指，地支不变时，仅将天干顺跳1次，干支次序c[+12]c；天干不变时，仅将地支逆跳1次，干支次序c[+10]c。比如：]",
            ...
            "h1[三、日期差值计算]h1",
            "[计算两个公历日期差值的方法。日期差值用c[dd]c代称。]",
            "h2[3.1 闰年数判断]h2",
            "[若经过的年数能被c[4]c整除。那么经过的闰年数为得到的商c[Q]c。如果不能被4整除：经过的年数除以4得到商c[Q]c后，如果在这些所经过的年份中，第一年或最后一年是闰年，那么闰年数为c[Q+1]c，否则为c[Q]c。比如：]",
            ...
            "[格里高利历自公元s[1582年10月15日]s（明万历十年九月十九日）起施行。根据历法，1582年10月删去了5日至14日共10天，因此15日的前一天是4日（明万历十年九月十八日）。故如果跨越了1582年10月4日、15日，则应该在最后环节v[{emphasis}减去10天]v。但应注意，在1582年10月4日之前，没有“整百年不闰但四百年一闰”的规则，凡是整百年都是闰年。br[]例如，计算s[1515年11月15日]s（明正德十年十月初十）-s[1853年2月7日]s（清咸丰二年腊月三十）的dd。先计算闰年数。1852-1516+1=337年，337/4商84，经历1700、1800两个平年，故共经历82个闰年，255个平年，覆盖366*82+365*255=123087天。dd=30+31+31-8+123087-10=123161天。]",
            "h2[3.3 儒略日计算]h2",
            "[取格里高利历或儒略历的日期。年数为c[Y]c，月数为c[M]c，日数为c[D]c。]",
            ...
            "[例如：计算2026年4月5日（正午12:00）的儒略日。取Y=2026，M=4，D=5，则A=floor(2026/100)=20，则B=2-20+floor(20/4)=-13。又365.25*(2026+4716)=2462515.5，30.6001*(4+1)=153.0005，故JD=2462515.5+153.0005+5-13-1524.5=2461136.001，即c[2461136]c。]",
            "[例如，计算7777年1月7日（注意，有较大误差）的儒略日。则A=77，77/4=19.25，则B=2-77+19=-56。又365.25*(7776+4716)=4562703，30.6001*(13+1)=428.4014，则JD=4562703+428.4014+7-56-1524.5=4561557.901，即c[4561558]c。]",
            "h1[四、新干支法]h1",
            "h2[4.1 干支历]h2",
            "[干支历主要由干支纪年（年柱）、干支纪月（月柱）、干支纪日（日柱）、干支纪时（时柱）四部分组成。从立春至下一立春为一岁，它以立春为岁首，交节日为月首。干支历属于阳历的范畴。]",
            "h3[4.1.1 月建]h3",
            "[北斗之斗柄所指的方位为确定月份的标准，称为“月建”。将一年划分为12个方位，对应12个月。将24个节气平均分配到12个月中，每个月只有2个节气。以立春交节时刻作为正月的起始。]",
            "[每个月建与地支相配，对应名称：]",
            ...
            "[经过天文计算，已知2026年清明交节时间为4月5日02:39:57，且2026年三月的干支为壬辰(29)。那么在2026年4月5日02:39:57之后的时间为壬辰月，而在这之前的时间，如2026年4月5日02:10:00，则属于辛卯(28)月。这就叫作“s[交节时刻为月首]s”，而非“子时作月首”。]",
            "h4[4.1.1.1 月建方位]h4",
            "[众所周知，有“北斗东指，天下皆春”的说法。古人在黄昏时刻观察北斗斗柄指向的方向来确定此时的节气。如上文叙述，各个地支对应一个方位，12个地支对应12个方位，故有“子午线”“卯酉圈”之称。]",
            "t[^^|季节|方位|节气|月序|地支",
            ...
            "h4[4.1.2 《尔雅·释天》]h4",
            "[《尔雅·释天》中记载了s[太岁纪年法]s里各天干、各地支的年和月对应的名字，成为后世干支纪年法的前身。]",
            ...
            "[早在《离骚》中就有q[s[摄提]s贞于孟s[陬]s兮]q的陈述。但由于后世对“摄提”的内涵界定不一，屈原的生辰仍无法定论。]",
            "h3[4.1.3 八字]h3",
            "[即干支历中年柱、月柱、日柱和时柱的合称。由于每个柱都是两个字的干支，总共八个字，故称“八字”。br[]每一个时刻对应一个八字。比如，2000年1月1日08:00:00对应八字为“s[己卯]s(年) s[丙子]s(月) s[戊午]s(日) s[丙辰]s(时)”。]",
            "h2[4.2 干支历历法]h2",
            "[年、月、日、时柱都有对应干支。年月柱和日时柱是两套不同的机制，相互独立，互不影响。][年月柱的最小单位是月柱。当丑月结束(立春交节)后进入寅月时，年柱干支换为第二年的干支。br[]日时柱的最小单位是时柱。当亥时结束(本地真太阳时23:00:00)后进入子时，日柱换为第二日的干支。][比如，已知2026年是丙午年，2026年正月的干支是庚寅，2026年立春交节在2月4日04:02:05，2月4日的日柱是己酉，2月4日04:02:05所在的时柱是丁卯。br[]那么，对于121.25°E处的以下时间点（注意观察年月柱与日时柱切换的独立性）：]",
            "t[^^|日期|时刻|年|月|日|时||",
            ...
            "h3[4.2.1 循环性]h3",
            "[一般地，八字以60年为循环。但是，由于每年各节气的交节时间不一致，导致很多八字以大于60年的周期重新出现。br[]对八字s[丙午 壬辰 丁巳 庚子]s，反推公历日期有（18世纪及之后）：ul[|c[2026-04-13 00:00]c|c[1966-04-28 00:00]c|c[1786-04-11 00:00]c|c[1726-04-26 00:00]c]ul可见19世纪不存在八字为“丙午 壬辰 丁巳 庚子”的时刻。]",
            "h3[4.2.2 五虎遁元]h3",
            "[需要明确的是，甲子年没有甲子月。规定，所有甲年的第一个月都是丙寅月，接着顺次排列，丁卯、戊辰、己巳、庚午、辛未、壬申、癸酉、甲戌、乙亥、丙子，最后是丁丑月。然后，进入第二年乙年，正月便是是戊寅(15)月。以此顺推，丙年的正月是庚寅(27)月，丁年的正月是壬寅(39)月，戊年的正月是甲寅(51)月，己年的正月又是丙寅(3)月。可发现每经过5年，月柱循环一次，因为c[12*5=60]c；10个天干每循环一次，月柱将循环2次。][对于不同天干的年份，其正月(寅月)的天干由上一段所述的规则确定。后人编写了一个口诀来记忆这个规则，由于正月的地支“寅”对应生肖“虎”，这个口诀因此叫作“五虎遁元”（简称“五虎遁”）。]",
            ...
            "h3[4.2.3 五鼠遁元]h3",
            "[与五虎遁元一样，五鼠遁元是日柱的天干确定之时，确定时柱的天干的口诀。与月柱以寅为起始不同，时柱以子为起始。即存在“甲子日甲子时”，规定甲日的第一个时辰为甲子时，依次顺推，乙日的第一个时辰为丙子(13)时，丙日为戊子(25)，丁日为庚子(37)，戊日为壬子(49)，然后己日的第一个时辰又是甲子(1)时。时柱的周期规律与月柱的相同。由于每日第一个时辰的地支“子”的生肖为“鼠”，故这个口诀叫作“五鼠遁元”（简称“五鼠遁”）。]",
            "bq[ƈ{cross}[甲己还加s[甲]s，乙庚s[丙]s作初。br[]丙辛从s[戊]s起，丁壬s[庚]s子居。br[]戊癸起s[壬]s子，周而复始求。br[]]]bq",
            "[v[{emphasis}再简化之，可直接记忆“甲丙戊庚壬”。]v]",
            "[通过五虎遁可以判断某年是否有某月，通过五鼠遁可判断某日是否有某时。比如：]",
            ...
            "h1[五、总结]h1",
            "[新干支法在干支法的基础上添加了干支历的规律。可供传统命理学、传统国学、古历法爱好者等入门使用。]",
    ...
    },
    {
        ...
        contents: [
            ...
            "i[主，我们的明月！降下你的光芒！]i",
            "hr[]",
            "bq[ƈ{cross}[Columbina:br[]",
            "\"Quid tristes querimoniae, si non supplicio culpa reciditur?]]bq",
            "[副+形主格+名主格，连+副+名方式夺格+名主格+被动三单]",
            "i[哥伦比娅：br[]“若罪不依法而诛，那么悲怨又有何益？]i",
            "hr[]",
            "bq[ƈ{cross}[\"Sonitumne ferrorum audis?]]bq",
            "[名宾格附疑问助词+名属格+主动现在二单]",
            "i[“你可听见兵戈之声？]i",
            "hr[]",
            "bq[ƈ{cross}[\"Clamor gentium est ille, haud lamentum ergastuli.\"]]bq",
    ...
    },
    {
        ...
        contents: [
            ...
            "[Quincy的续写]",
            "bq[ƈ{cross}[i[1 in floribus ambulat,]i][i[2 pulchra claraque est.]i]",
