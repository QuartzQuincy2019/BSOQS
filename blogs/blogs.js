    ...
    */
    {
        ...
        contents: [
            ...
            "h2[2.7 冲日和合日]h2",
            "[%{TI}s[冲日]s，是指一个天体运行到“太阳——地球——天体”呈一条直线的位置。此时，该天体完全背离太阳光线，最适合观测。s[合日]s则相反，是指一个天体运行到“天体——太阳——地球”呈一条直线的位置，此时该天体完全被太阳遮挡，完全不可见。一般对于地球外侧行星论“冲日”和“合日”，比如“火星冲日”。联想“卫星追及”问题。][%{TI}不过，s[广义]s的冲日和合日也存在，即在s[黄道坐标系]s中，该天体的s[黄经]s与太阳此时的黄经相差c[180°]c，则该天体冲日。如果该天体的黄经与同样相同，则该天体合日。下面是一年中各节气对应的s[太阳黄经]s：]",
            ...
            "[%{TI}图七是公元2026年6月24日21:00:00时烟台市的夏季大三角（提高了光污染）示意图。夏季大三角由最亮的s[织女一]s（织女星/天琴座α/α Lyr）、其次亮的s[河鼓二]s（牛郎星/天鹰座α/α Aql）和亮度排行最后的s[天津四]s（天鹅座α/α Cyg）组成。]",
            "h1[三、其他]h1",
