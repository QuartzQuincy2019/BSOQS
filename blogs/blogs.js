    ...
    */
    {
        ...
        contents: ["h1[零、前言]h1",
            ...
            "|s[求特定次序的干支]s 求次序为27的干支。甲子(1)→天干顺跳→丙子(13)→天干顺跳→戊子(25)→己丑(26)→庚寅(27)。也可甲子(1)→地支顺跳→甲寅(1-10+60=51)→地支顺跳→甲辰(41)→地支顺跳→甲午(31)→癸巳(30)→壬辰(29)→辛卯(28)→甲寅(27)。]ul",
            "h1[三、日期差值计算]h1",
            ...
            "[若跨越整百但不闰的年份，需要额外减去。例如：判断1867-2021所经闰年数。年数为155年，商为38，跨越了1900年(该年是平年)，故所经闰年数为37。判断1751-2420所经闰年数。年数为670年，商167，而2420年是闰年，故得数为168，而1800、1900、2100、2200、2300是平年，故所经闰年数为s[163]s。]",
            "h2[3.2 日数差值判断]h2",
            "[先将年份统一，再统一月份，再统一到日。]",
            ...
            "2月4日|04:02:05|s[丙午]s|s[庚寅]s|己酉|丙寅|$]t",
            "q[* 这里为了简化说明，忽略了真太阳时与平太阳时的时间差。按照传统理解，23:00:00-次日00:59:59属于s[次日]s的子时。]qbr[]",
            "h3[4.2.1 循环性]h3",
            "[一般地，八字以60年为循环。但是，由于每年各节气的交节时间不一致，导致很多八字以大于60年的周期重新出现。br[]对八字s[丙午 壬辰 丁巳 庚子]s，反推公历日期有：c[2026-04-13 00:00]c、c[1966-04-28 00:00]c、c[1786-04-11 00:00]c和c[1726-04-26 00:00]c等，可见19世纪不存在八字为“丙午 壬辰 丁巳 庚子”的时刻。]",
            "h3[4.2.2 五虎遁元]h3",
