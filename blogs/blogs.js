    ...
    */
    {
        ...
        contents: [
            ...
            "t[%{ara inlineblock}^#|过去式|现在式|注释||c[faꜥ?la]c|c[yafꜥ?lu]c|第三人称阳性单数||[فَعَلَ]|[يَفْعَلُ]|a-a||[فَعَلَ]|[يَفْعِلُ]|a-i||[فَعَلَ]|[يَفْعُلُ]|a-u||[فَعِلَ]|[يَفْعَلُ]|i-a||[فَعِلَ]|[يَفْعِلُ]|i-i||[فَعُلَ]|[يَفْعُلُ]|u-u|$]t",
            ...
            "t[%{ara inlineblock}^#|过去式|现在式|注释||c[faꜥ?latā]c|c[tafꜥ?lāni]c|第三人称阴性双数||[فَعَلَتَا]|[تَفْعَلَانِ]|a-a||[فَعَلَتَا]|[تَفْعِلَانِ]|a-i||[فَعَلَتَا]|[تَفْعُلَانِ]|a-u||[فَعِلَتَا]|[تَفْعَلَانِ]|i-a||[فَعِلَتَا]|[تَفْعِلَانِ]|i-i||[فَعُلَتَا]|[تَفْعُلَانِ]|u-u|$]t",
            ...
            "t[%{ara inlineblock}^|过去式变位|阳性|转写|阴性|转写||单数|[فَعلَ]|c[faꜥ?la]c|[فَعلَتْ]|c[faꜥ?lat]c||双数|[فَعلَا]|c[faꜥ?lā]c|[فَعلَتَا]|c[faꜥ?latā]c||复数|[فَعلُوا]|c[faꜥ?lū]c|[فَعلْنَ]|c[faꜥ?lna]c]t",
            "t[%{ara inlineblock}^|现在式变位|阳性|转写|阴性|转写||单数|[يَفْعلُ]|c[yafꜥ?lu]c|[تَفْعلُ]|c[tafꜥ?lu]c||双数|[يَفْعلَانِ]|c[yafꜥ?lāni]c|[تَفْعلَانِ]|c[tafꜥ?lāni]c||复数|[يَفْعلُونَ]|c[yafꜥ?lūna]c|[يَفْعلْنَ]|c[yafꜥ?lna]c]t",
            "h2[三母简式动词 第一人称变位范式]h2",
            "[第一人称变位s[没有双数、阴阳性相同]s。]",
            "t[%{ara inlineblock}^|过去式变位|阳性|转写|阴性|转写||单数|{c4}[فَعلْتُ] c[faꜥ?ltu]c||复数|{c4}[فَعلْنَا] c[faꜥ?lnā]c]t",
            "t[%{ara inlineblock}^|现在式变位|阳性|转写|阴性|转写||单数|{c4}[أفْعلُ] c['afaꜥ?lu]c||复数|{c4}[نَفْعلُ] c[nafꜥ?lu]c]t",
            "h2[三母简式动词 第二人称变位范式]h2",
            "t[%{ara inlineblock}^|过去式变位|阳性|转写|阴性|转写||单数|[فَعلْتَ]|c[faꜥ?lta]c|[فَعلْتِ]|c[faꜥ?lti]c||双数|{c4}[فَعلْتُمَا] c[faꜥ?ltumā]c||复数|[فَعلْتُمْ]|c[faꜥ?ltum]c|[فَعلْتُنَّ]|c[faꜥ?ltunna]c]t",
