    ...
    */
    {
        ...
        contents: ["[%{TI}关于博客页日历功能有以下几点说明：]",
            "h1[快捷键]h1",
            "[%{TI}按c[0]c键可解除实时显示锁定，再按将返回到当前时间，并开启实时显示锁定。在结束锁定的情况下：]",
            "ul[|c[=]c下一时辰|c[-]c上一时辰",
            "|c[P]c下一日|c[O]c上一日",
            "|c[L]c下一月|c[K]c上一月",
            "|c[,]c下一年|c[M]c上一年]ul",
            ...
            "h1[历法问题]h1",
            "[%{TI}格里高利历于1582年10月15日开始实行，在新历法中，1582年10月4日的下一天是10月15日，但是JavaScript的Date对象可以正常处理1582年10月4日和10月15日之间的日期。BlogSpace的日历功能依赖tyme.js库，1582年10月5日至10月14日的日期将被视为无效日期。故BlogSpace黄历不会显示这些日期。]",
            "[%{TI}公元237年，魏明帝曹叡推行历法改革，原青龙五年三月变为景初元年四月，则该年农历无三月份，即237年4月12日为四月初一而非三月初一。但tyme.js库并未实现这一点，因此在BlogSpace农历视图中，237年4月12日为三月初一。此后实际历法的农历都比BlogSpace领先一个月。但bq[[《三国志·魏书·少帝纪第四》][%{TI}十二月，诏曰：“烈祖明皇帝以正月弃背天下，臣子永惟忌日之哀，其复用夏正；虽违先帝通三统之义，斯亦礼制所由变改也。又夏正於数为得天正，其以建寅之月为正始元年正月，以建丑月为后十二月。”]]bq][%{TI}故公元240年恢复，1月12日为十二月初一，之后BlogSpace的农历于实际历法相同。]"
        ]
    },
    {
        type: "blog",
